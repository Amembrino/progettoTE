...
String tutorUni= request.getParameter("tutorUni"); %>
   ...
   <br>email
  <input type="text" value="<% out.print(email); %>" name="Email"> 
  
  <br> azienda
  <input type="text" value="<% out.print(azienda); %>" name="azienda"> 
  <br> Tutor universitario
  <input type="text" value="<% out.print(tutorUni); %>" name="tutorUni"> 
