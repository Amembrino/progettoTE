...
String query="SELECT registro_tirocinio.ID_Tirocinio FROM registro_tirocinio, domanda_di_tirocinio WHERE registro_tirocinio.Tirocinante_Email='"+tiro+"' ";
	try{
